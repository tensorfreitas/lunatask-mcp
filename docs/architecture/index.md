...
- [LunaTask MCP Server Architecture Document](#table-of-contents)
  ...
  - [4. Data Models](./4-data-models.md)
    - [Task Models](./4-data-models.md#task-models)
      - [ (Nested Response Model)](./4-data-models.md#nested-response-model)
      - [ (Response Model)](./4-data-models.md#response-model)
      - [ (Request Model)](./4-data-models.md#request-model)
      - [ (Request Model)](./4-data-models.md#request-model)
    - [Habit Models](./4-data-models.md#habit-models)
      - [ (Request Model)](./4-data-models.md#request-model)
  - [5. Components](./5-components.md)
    - [1.  (Service Component)](./5-components.md#1-service-component)
    - [2.  (MCP Interface Component)](./5-components.md#2-mcp-interface-component)
    - [3.  (MCP Interface Component)](./5-components.md#3-mcp-interface-component)
    - [4.  (Application Runner)](./5-components.md#4-application-runner)
