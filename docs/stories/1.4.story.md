...
## Tasks / Subtasks
- [ ] Task 1: Create LunaTask API client component (AC: 1, 2, 3)
  - [ ] Subtask 1.1: Create `src/lunatask_mcp/api/client.py` with LunaTaskClient class
  - [ ] Subtask 1.2: Add initialization with bearer token from configuration
  - [ ] Subtask 1.3: Implement secure authentication header handling with token redaction
  - [ ] Subtask 1.4: Add async HTTP client setup using httpx
  - [ ] Subtask 1.5: Implement authenticated request method with proper error handling
