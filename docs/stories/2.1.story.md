...
### File List
- **Modified**: `src/lunatask_mcp/api/client.py` - Added get_tasks method
- **Created**: `src/lunatask_mcp/api/models.py` - TaskResponse and Source models
- **Modified**: `tests/test_api_client.py` - Added comprehensive get_tasks test suite
- **Created**: `src/lunatask_mcp/tools/__init__.py` - Tools module for MCP resources integration
- **Created**: `src/lunatask_mcp/tools/tasks.py` - TaskTools class with lunatask://tasks MCP resource
- **Modified**: `src/lunatask_mcp/main.py` - Integrated TaskTools into CoreServer
- **Created**: `tests/test_task_tools.py` - Comprehensive TaskTools test suite (7 test scenarios)
- **Modified**: `tests/test_main.py` - Added CoreServer TaskTools integration tests (5 additional test scenarios)
- **Modified**: `src/lunatask_mcp/tools/tasks.py` - Enhanced error handling with structured MCP responses for specific error types
- **Modified**: `tests/test_task_tools.py` - Added comprehensive error handling test coverage (5 additional test scenarios)
