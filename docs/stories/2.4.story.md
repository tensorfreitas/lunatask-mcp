...
- [ ] Task 3: End-to-End validation testing (AC: 1, 2, 3)
  ...
  - [ ] Subtask 3.2: Test complete tool execution flow from MCP client perspective with partial updates
  - [ ] Subtask 3.3: Validate MCP error responses for 404, validation errors, and auth errors
  - [ ] Subtask 3.4: Confirm rate limiter applies to PATCH requests
  - [ ] Subtask 3.5: Test timezone handling for due_date parameter
- [ ] Task 4: Update project documentation (AC: 1, 2)
  - [ ] Subtask 4.1: Update README.md with update_task tool usage examples
  - [ ] Subtask 4.2: Document tool parameters and their types/requirements (especially partial update behavior)
  - [ ] Subtask 4.3: Document error scenarios and expected MCP error responses
  - [ ] Subtask 4.4: Update API coverage documentation to include PATCH /v1/tasks/{id} endpoint
